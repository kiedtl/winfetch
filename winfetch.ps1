...
$img = if (-not $noimage) {
    if ($image) {
        ...
        if ($logo -eq "Windows 11") {
        ...
        } elseif ($logo -eq "Agaheo face") {
            $COLUMNS = 30 # Agaheo face
            @(
            "${e}[${t};34m⠄⠄⠄⢰⣧⣼⣯⠄⣸⣠⣶⣶⣦⣾⠄⠄⠄⠄⡀⠄⢀⣿⣿⠄⠄⠄⢸⡇⠄⠄"
			"${e}[${t};34m⠄⠄⠄⣾⣿⠿⠿⠶⠿⢿⣿⣿⣿⣿⣦⣤⣄⢀⡅⢠⣾⣛⡉⠄⠄⠄⠸⢀⣿⠄"
			"${e}[${t};34m⠄⠄⢀⡋⣡⣴⣶⣶⡀⠄⠄⠙⢿⣿⣿⣿⣿⣿⣴⣿⣿⣿⢃⣤⣄⣀⣥⣿⣿⠄"
        ...
        } elseif ($logo -eq "Linux") {
            $COLUMNS=46

            @(
                "${e}[${t};37m                .88888888:."
                "${e}[${t};37m                88888888.88888."
                "${e}[${t};37m              .8888888888888888."
                "${e}[${t};37m              888888888888888888"
                "${e}[${t};37m              88' _ 88'_   88888"
                "${e}[${t};37m              88 88 88 88  88888"
                "${e}[${t};37m              88_88_::_88_:88888"
                "${e}[${t};37m              88${e}[33m:::,::,::::: ${e}[37m8888"
                "${e}[${t};37m              88${e}[33m':::::::::'  ${e}[37m8888"
                "${e}[${t};37m             .88${e}[33m   ::::'     ${e}[37m8:88."
                "${e}[${t};37m            8888            '8:888."
                "${e}[${t};37m          .8888'             '888888."
                "${e}[${t};37m         .8888:..  .::.  ...:'8888888:."
                "${e}[${t};37m        .8888.'     :'      '::'88:88888"
                "${e}[${t};37m       .8888        '         '.888:8888."
                "${e}[${t};37m      888:8         .           888:88888"
                "${e}[${t};37m    .888:88        .:           888:88888:"
                "${e}[${t};37m    8888888.       ::           88:888888"
                "${e}[${t};33m    '.::.${e}[37m888.      ::          .88888888"
                "${e}[${t};33m   .::::::.${e}[37m888.    ::         ${e}[33m:::${e}[37m'8888'${e}[33m.:."
                "${e}[${t};33m  ::::::::::.${e}[37m888   '         ${e}[33m.::::::::::::"
                "${e}[${t};33m  ::::::::::::.${e}[37m8    '      .:8${e}[33m::::::::::::."
                "${e}[${t};33m .::::::::::::::. ${e}[37m       .:888${e}[33m:::::::::::::"
                "${e}[${t};33m :::::::::::::::${e}[37m88:.__..:88888${e}[33m:::::::::::'"
                "${e}[${t};33m   '.:::::::::::${e}[37m88888888888.88${e}[33m:::::::::'"
                "${e}[${t};33m         ':::_:' -- '' -'-'  ${e}[33m':_::::'"
            ...
            Write-Error 'The only version logos supported are Windows 11, Windows 10/8.1/8, Windows 7/Vista/XP and Microsoft. If you want another imaga, you can write Arch | Android | Ubuntu | Fedora | Red Hat | SUSE | Debian | Zorin | Agaheo face | Linux | UwU  --> with double quotes after winfetch -logo '
            exit 1
        }
    }
}
