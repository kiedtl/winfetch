...
According to [benchmarks](https://github.com/kiedtl/winfetch/wiki/Winfetch-vs-Neofetch) done with Hyperfine, Winfetch on Windows is faster than [Neofetch](https://github.com/dylanaraps/neofetch) running on Bash emulators like MSYS (Git Bash) or Cygwin.
